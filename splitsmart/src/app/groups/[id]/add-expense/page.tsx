  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col font-mono relative overflow-hidden">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-8 md:px-6 space-y-6 relative z-10">
        ...
        {/* Back Link */}
        <Link href={`/groups/${group.id}`} className="flex items-center gap-1.5 text-[10px] text-primary font-bold hover:underline mb-2 uppercase tracking-wider">
          <ArrowLeft className="h-3.5 w-3.5" /> [ABORT_TO_CHANNEL]
        </Link>

        <div className="hud-card rounded-none p-6 md:p-8 space-y-6">
          <div className="border-b border-primary/20 pb-4">
            <h1 className="text-xl font-bold uppercase tracking-widest text-primary">// LOG_TRANSACTION_SPLIT</h1>
            <p className="text-[10px] text-gray-500 mt-1 uppercase">Define expense weights, payer metrics, and split parameters.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              <Coins className="h-4 w-4" /> Commit Ledger Entry
            </button>
