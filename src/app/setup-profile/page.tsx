  ...
  return (
    <div className="min-h-screen bg-black text-white font-body flex flex-col items-center justify-center p-4 py-8 relative overflow-y-auto">
      ...
      <main className="relative z-10 w-full max-w-[440px] px-4 my-auto">
        <div className="bg-[#0b0b0b] border-2 border-secondary/20 backdrop-blur-xl p-6 md:p-8 rounded-none shadow-[0_0_50px_rgba(0,240,255,0.1)] relative overflow-hidden">
          
          <div className="flex justify-center mb-5">
            <div className="relative w-16 h-16 flex items-center justify-center bg-zinc-950 border-2 border-secondary rounded-none shadow-[0_0_20px_rgba(0,240,255,0.35)]">
          ...
          <div className="mb-6 border border-primary/20 bg-primary/5 p-4 rounded-none font-mono text-[10px] text-primary uppercase tracking-wide leading-relaxed flex items-start gap-2.5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative group">
              ...
              <input
                ...
                disabled={loading}
                required
                className="w-full bg-black/60 border border-zinc-800 focus:border-secondary px-5 py-3.5 font-mono text-xs uppercase tracking-wider text-white outline-none transition-all placeholder:text-zinc-700 rounded-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-secondary text-black font-headline font-black py-4 uppercase tracking-[0.25em] text-xs hover:bg-white hover:shadow-[0_0_25px_rgba(0,240,255,0.4)] transition-all flex justify-center items-center gap-2 disabled:opacity-40 rounded-none cursor-pointer"
            >
              {checking ? (
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-transparent border border-zinc-800 hover:border-zinc-500 text-zinc-500 hover:text-white font-mono text-[10px] py-3.5 uppercase tracking-widest transition-all rounded-none mt-2 cursor-pointer"
            >
              CANCEL & SIGN OUT
            </button>
          </form>
