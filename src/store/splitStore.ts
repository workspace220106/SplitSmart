...
import { SplitUser, Group, Expense, Settlement } from '@/types';

interface SplitStore {
  currentUser: SplitUser;
  usersList: SplitUser[];
  groups: Group[];
  expenses: Expense[];
  ...
  // Actions
  setCurrentUser: (user: SplitUser) => void;
  addUser: (name: string, email: string, upiId?: string) => SplitUser;
